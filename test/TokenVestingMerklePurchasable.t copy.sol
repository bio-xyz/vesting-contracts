...
contract TokenVestingV2MerklePurchasableTest is Test {
    ...
    TokenVestingMerklePurchasable internal tokenVesting2;
    ...
    function setUp() public {
        ...
        token.transfer(address(tokenVesting), tokenSupply);
    ...
    function testCanOnlyClaimOnce() public {
        ...
        vm.startPrank(alice);
        tokenVesting.claimSchedule{ value: purchasePrice }(aliceProof, baseTime, cliff, duration, 1, true, claimableAmount);
        vm.expectRevert(TokenVestingMerklePurchasable.AlreadyClaimed.selector);
        tokenVesting.claimSchedule{ value: purchasePrice }(aliceProof, baseTime, cliff, duration, 1, true, claimableAmount);
        vm.stopPrank();
    ...
    function testProofMustBeValid() public {
        ...
        vm.expectRevert(TokenVestingMerklePurchasable.InvalidProof.selector);
